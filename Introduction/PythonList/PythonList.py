...
thislist = ["apple", "banana", "cherry", "Dry Fruits"]
print(len(thislist))

# other example list inside a list
thislist = [mylist,"apple"]
print(thislist)
...
thislist = list(("apple", "banana", "cherry"))  #note: doble round brackets
print(thislist)
